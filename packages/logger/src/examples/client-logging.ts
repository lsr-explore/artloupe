...
export const clientLogger = {
	info: (message: string, context?: Record<string, unknown>) =>
		logClientEvent('/api/log', { level: 'info', message, context: context || {} }),
	
	warn: (message: string, context?: Record<string, unknown>) =>
		logClientEvent('/api/log', { level: 'warn', message, context: context || {} }),
	
	error: (message: string, context?: Record<string, unknown>) =>
		logClientEvent('/api/log', { level: 'error', message, context: context || {} }),
	
	debug: (message: string, context?: Record<string, unknown>) =>
		logClientEvent('/api/log', { level: 'debug', message, context: context || {} }),
};
...
export class AdvancedClientLogger {
	...
	private async sendLog(level: string, message: string, context?: Record<string, unknown>) {
